...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-food-safety-food-safety-module"], {
  ...
  /***/
  function srcAppModulesFoodSafetyFoodSafetyComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FoodSafetyComponent", function () {
    ...
    var FoodSafetyComponent =
    /*#__PURE__*/
    function () {
      function FoodSafetyComponent() {
        _classCallCheck(this, FoodSafetyComponent);
      }

      _createClass(FoodSafetyComponent, [{
        key: "ngOnInit",
    ...
    FoodSafetyComponent.ɵfac = function FoodSafetyComponent_Factory(t) {
      return new (t || FoodSafetyComponent)();
    };

    FoodSafetyComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: FoodSafetyComponent,
      selectors: [["app-food-safety"]],
      decls: 4,
      vars: 0,
      consts: [[1, "container", "py-5"], [1, "row"]],
      template: function FoodSafetyComponent_Template(rf, ctx) {
        if (rf & 1) {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FoodSafetyComponent, [{
  ...
  /***/
  function srcAppModulesFoodSafetyFoodSafetyModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FoodSafetyModule", function () {
    ...
    var _food_safety_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var FoodSafetyModule = function FoodSafetyModule() {
      _classCallCheck(this, FoodSafetyModule);
    };

    FoodSafetyModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: FoodSafetyModule
    });
    FoodSafetyModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function FoodSafetyModule_Factory(t) {
        return new (t || FoodSafetyModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](FoodSafetyModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FoodSafetyModule, [{
...
//# sourceMappingURL=modules-food-safety-food-safety-module-es5.js.map